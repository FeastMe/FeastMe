...
-- Add a new food
INSERT INTO foods(food_id, order_id, food_name, description, is_vegan, is_vegetarian, price) VALUES (:order_id_FK, :food_name_input, :description_input, :is_vegan_input, :is_vegetarian_input, :price_input);
...
SELECT drivers.account_id, CONCAT(first_name, ' ', last_name), license_plate, license_number FROM accounts
...
SELECT order_id, CONCAT(first_name, ' ', last_name) AS ordered_by, street_number, street, unit_number, city, state, zip_code, CONCAT(street_number, ' ', street, ' ', unit_number, ' ', city, ' ', state, ' ', zip_code) AS patron_address, license_plate, order_time, total_price, order_status 
FROM orders
...
SELECT order_id, ordered_by, delivery_by, order_time, total_price, order_status FROM orders WHERE ordered_by = :ordered_by_input OR delivery_by = :delivery_by_input;
-- Get all foods information
SELECT * FROM foods;
-- Search foods entity by food name
SELECT food_id, order_id, food_name, description, is_vegan, is_vegetarian, price FROM foods WHERE food_name = :food_name_input;
